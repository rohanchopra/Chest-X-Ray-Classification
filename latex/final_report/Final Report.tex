...
the art approaches. Since then there has been a dramtic increase in application of CNNs 
...
a patient and used to give radiologist level prediction on the go. 
